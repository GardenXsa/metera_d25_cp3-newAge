...
```
node tools/runtime_smoke_check.js  →  84 checks, 0 failed, 0 warnings
...
4. **Smoke-check зелёный: 84/0** — базовая точка после UTF-8/Mojibake guard для quick tags на 2026-05-26. Полная быстрая проверка: `npm run verify`.
