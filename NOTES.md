...
```
node tools/runtime_smoke_check.js  →  74 checks, 0 failed, 0 warnings
...
4. **Smoke-check зелёный: 74/0** — базовая точка после character stats contract preflight на 2026-05-25. Полная быстрая проверка: `npm run verify`.
