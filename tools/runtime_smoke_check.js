...
function checkExpectedFiles() {
  const expected = [
    ...
    'tests/world_lore_cache_invalidation.test.js',
    'tests/era_lore_cyberpunk_removal.test.js',
    'tests/genre_lock_high_fantasy.test.js',
...
function main() {
  ...
  runNodeTool('tests/ai_error_retry_button.test.js', 'ai error retry button tests');
  runNodeTool('tests/environment_visibility_fuzzy.test.js', 'environment visibility fuzzy tests');
  runNodeTool('tests/world_lore_cache_invalidation.test.js', 'world lore cache invalidation tests');
  runNodeTool('tests/era_lore_cyberpunk_removal.test.js', 'era_lore cyberpunk-removal tests');
  runNodeTool('tests/genre_lock_high_fantasy.test.js', 'genre lock high-fantasy tests');
  printResults();
}
