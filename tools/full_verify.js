...
function main() {
  ...
  runIfExists('vanilla data lore conformance tests', 'tests/vanilla_data_lore_conformance.test.js', process.execPath, ['tests/vanilla_data_lore_conformance.test.js']);
  runIfExists('vanilla map palette tests', 'tests/vanilla_map_palette.test.js', process.execPath, ['tests/vanilla_map_palette.test.js']);
  runIfExists('cartographer bridge rendering tests', 'tests/cartographer_bridge_rendering.test.js', process.execPath, ['tests/cartographer_bridge_rendering.test.js']);
